...
> **TL;DR:** I pay €9/month for Amazon Prime. Amazon uses €0.30 of that to serve me ads. I spent ~$500 in AI tokens and several days of effort to fix this. Totally worth it. Probably.
...
Stage 2: anger. "This is illegal in at least three countries."
...
ReVanced is a project that patches Android apps to remove ads. There's even a patch for Amazon Prime Video — for a version from 2025. The current version is... not that.
...
By Tuesday it had auth, token refresh, and a catalog browser.

Halfway through Wednesday, **my living room TV turned on.**
...
The PoC phase cost ~$30 in AI tokens and half a day. Getting to a usable app with all features: another ~$50 over two days. Then I got greedy and asked for a fancy UI.

Three days, ~$400, and the combined forces of Claude and Codex later — I had a Leanback-compatible Fire TV UI with category filters, search suggestions, watchlist, and an adaptive bitrate player that decoded H.264 in Widevine L1 hardware secure mode.

This phase was different from the PoC. The AI didn't just run unsupervised through meetings — it needed me. Several rounds of guidance over multiple days: "that button is in the wrong place", "the crash happens when you scroll fast", "yes I know it compiles, but it looks terrible." Turns out AI is great at building things and less great at knowing what looks good on a TV from three metres away.
